...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
        ...
        # print("memory_image: ", memory_image)
        print("memory_image size: ", memory.size())
        ...
        if not self.omit_selfattn:
            ...
            # print("tgt: ", tgt)
            print("tgt2 1 size: ", tgt2.size())

            tgt = tgt + self.dropout1(tgt2)
            tgt = self.norm1(tgt)

            # print("tgt: ", tgt)
            print("tgt 1 size: ", tgt.size())
