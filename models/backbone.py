...
import models.tresnet
import models.tresnet_v2
    ...
    def __init__(self, name: str,
        ...
        if name in ['resnet18', 'resnet50', 'resnet34', 'resnet101']:
            ...
            if return_interm_layers:
                ...
                return_layers = {'layer4': "0"}
        elif name in ['tresnet', 'tresnetl', 'TResnetL','tresnetxl', 'TResnetL_V2']:
            backbone = getattr(models.tresnet_v2, name)(
                {'num_classes': 1}
            )
